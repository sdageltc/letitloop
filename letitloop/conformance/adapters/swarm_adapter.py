"""OpenAI Swarm / Multi-Agent adapter — durable handoff across agents.

Demonstrates durable context preservation across autonomous transfers:
...
class SwarmAdapter(FrameworkAdapter):
    ...
    def archetype_label(self) -> str:
        return "OpenAI Swarm (Multi-Agent Handoff)"
...
'''
    ...
    def resume_task(self, spec: SyntheticTaskSpec) -> DurabilityScore:
        ...
        return DurabilityScore(
            ...
            recovery_latency_seconds=latency + 0.03,
